...
def run(
	...
	print u'настраиваю и копирую страницу пользовательских настроек'
	...
	# xsl
	print u'настраиваю и копирую xsl-стили'
	...
	# css
	print u'настраиваю и копирую css-стили'
	shutil.copy(
		css_filename,
	...
	if images_dir and os.path.isdir( images_dir ):
		print u'копирую папку с изображениями...'
	...
	print u'dict_template: run: готово!'
